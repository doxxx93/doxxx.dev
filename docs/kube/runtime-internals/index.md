...
description: "kube-runtime의 내부 동작 — watcher state machine, reflector 캐싱, Controller 파이프라인"
---
...
[Architecture](../architecture/index.md) 섹션에서 kube의 정적 구조를 이해했다면, 이 섹션에서는 런타임에 실제로 벌어지는 일을 따라갑니다.
