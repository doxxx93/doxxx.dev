...
**Releases and versioning.** [PR #1884](https://github.com/kube-rs/kube/pull/1884) was a breaking change to make subresource methods more ergonomic. The timing worked out to land it in the 3.0.0 milestone.
...
**Bug hunting.** While implementing RetryPolicy, I was reading the existing watcher code and found a bug.
...
**CI and infrastructure.** After features and bug fixes, my attention shifted to the project's foundation, the kind of things most people overlook or leave untouched.
